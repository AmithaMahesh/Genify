...
**RAG Cycle:**  
1.Gemini receives the prompt.  
2.The Google Search Tool is triggered to pull the latest 2024-2025 data.  
3.Data is filtered for relevance and accuracy.  
4.Response Generation: Gemini synthesizes the search results into a clean Markdown response in the user's selected Indic language.  
